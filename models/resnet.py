# Modified from https://github.com/SkrighYZ/Osiris/blob/main/models/backbone.py, which was modified from https://github.com/huyvnphan/PyTorch_CIFAR10/blob/master/cifar10_models/resnet.py
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm='bn', group_element=4, act='relu'):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=100, zero_init_residual=True,
                 ...
                 norm='bn', group_element=4, act='relu', input_size=64):
...
if __name__ == "__main__":
    ...
    y = model(torch.randn(64, 3, 128, 128))
    print(y.size(), model)
